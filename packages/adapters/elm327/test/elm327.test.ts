...
import { Elm327Adapter, MemoryByteStream, formatIdentifier, formatSendPayload, isElmError, parseFrameLine } from '../src/index.js';
...
test('received frames reach subscribers and honour filters', async () => {
  ...
  adapter.subscribe((frame) => received.push(`0x${frame.id.toString(16)}`), [{ id: 0x7e8, mask: 0x7ff }]);
