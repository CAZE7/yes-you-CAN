...
export const vagExamplePackage: DefinitionPackage = {
  ...
  provenance: {
    ...
    notes: 'Replace with licensed OEM data before use on a real vehicle. Demonstrates 29-bit addressing and OEM DID layout only.',
  },
  ecus: [
    {
      id: 'engine',
      ...
      dtcs: [
        { code: 'P0420', description: 'Example: catalyst efficiency below threshold', severity: 'major' },
        { code: 'P1234', description: 'Example: OEM specific boost pressure control deviation', severity: 'minor' },
      ],
    },
  ],
  signals: [
