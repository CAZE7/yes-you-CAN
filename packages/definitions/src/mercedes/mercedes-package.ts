  ...
  ecus: [
    {
      ...
      dtcs: [
        { code: 'B1000', description: 'Example: body network communication fault', severity: 'minor' },
        { code: 'U0100', description: 'Example: lost communication with engine control module', severity: 'critical' },
      ],
    },
  ],
  signals: [
