...
export const genericPackage: DefinitionPackage = {
  ...
  provenance: {
    sourceType: "standard",
    source:
      "SAE J1979 / ISO 15031-5 PID semantics, ISO 14229-1 identification DIDs — own encoding, no third-party database used",
    version: "1.0.0",
