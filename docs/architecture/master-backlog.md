...
| 22 | dependency-cruiser | ✅ erledigt 2026-09-14 durch P0 #2 — **bewusst ohne dependency-cruiser** (ADR 0028): genau eine Quelle (`dependency-rules.json`) + eigenes Werkzeug mit Fixture-Beleg; dependency-cruiser brächte eine zweite Regel-DSL und würde die Allowlist erneut ausdrücken („kein zweites Vokabular für dieselbe Frage“, vgl. ADR 0026/ESLint) | Neu bewerten, sobald Regeln nötig werden, die Datei-Ebenen, Laufzeit-Zyklen oder Type-only-Kanten brauchen |
