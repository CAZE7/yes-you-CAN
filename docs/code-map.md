...
| Lizenz, Beiträge, Marke anfassen | `LICENSE` / `NOTICE` / `TRADEMARK.md` / `docs/legal/` | ADR 0061 (Lizenz) + 0062 (Vereinbarung), `tests/architecture/legal.test.ts` (Lizenztext, Manifeste, CLA-Verlinkung), `"license"` in **allen** Manifesten (`manifests.test.ts` hält die Gleichheit) |
